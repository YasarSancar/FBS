...
public struct Vector4fParamData : IFlatbufferObject
{
  ...
  public gfl.math.fb.Vector4f? Value { get { int o = __p.__offset(10); return o != 0 ? (gfl.math.fb.Vector4f?)(new gfl.math.fb.Vector4f()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public gfl.gfx2.fb.RuntimeCurveFloat4? CurveValue { get { int o = __p.__offset(12); return o != 0 ? (gfl.gfx2.fb.RuntimeCurveFloat4?)(new gfl.gfx2.fb.RuntimeCurveFloat4()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static Offset<gfl.debug_framework.fb.light.Vector4fParamData> CreateVector4fParamData(FlatBufferBuilder builder,
    ...
    Vector4fParamData.AddLightUniqueId(builder, lightUniqueIdOffset);
    Vector4fParamData.AddCurveValue(builder, curveValueOffset);
    ...
    Vector4fParamData.AddTypeName(builder, typeNameOffset);
    Vector4fParamData.AddLightName(builder, lightNameOffset);
    return Vector4fParamData.EndVector4fParamData(builder);
  }

  public static void StartVector4fParamData(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static void AddValue(FlatBufferBuilder builder, Offset<gfl.math.fb.Vector4f> valueOffset) { builder.AddStruct(3, valueOffset.Value, 0); }
  public static void AddCurveValue(FlatBufferBuilder builder, Offset<gfl.gfx2.fb.RuntimeCurveFloat4> curveValueOffset) { builder.AddOffset(4, curveValueOffset.Value, 0); }
  ...
  public static Offset<gfl.debug_framework.fb.light.Vector4fParamData> EndVector4fParamData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<gfl.debug_framework.fb.light.Vector4fParamData>(o);
  }
  public static void FinishVector4fParamDataBuffer(FlatBufferBuilder builder, Offset<gfl.debug_framework.fb.light.Vector4fParamData> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedVector4fParamDataBuffer(FlatBufferBuilder builder, Offset<gfl.debug_framework.fb.light.Vector4fParamData> offset) { builder.FinishSizePrefixed(offset.Value); }
  ...
  public static Offset<gfl.debug_framework.fb.light.Vector4fParamData> Pack(FlatBufferBuilder builder, Vector4fParamDataT _o) {
    if (_o == null) return default(Offset<gfl.debug_framework.fb.light.Vector4fParamData>);
